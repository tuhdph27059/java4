...
<table class="table table-hover table-bordered">
    ...
    <tbody>
    <c:forEach items="${listSanPham}" var="kh">
        <tr>
            <td scope="row">${kh.id}</td>
            <td>${kh.ma}</td>
            <td>${kh.ten}</td>
            <td>
                <a href="/san-pham/detail?id=${kh.id}" class="btn btn-success">Detail</a>
                <a href="/san-pham/delete?id=${kh.id}" class="btn btn-danger">Xóa</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
