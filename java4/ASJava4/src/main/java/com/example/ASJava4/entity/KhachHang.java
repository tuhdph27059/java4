...
//@Table(name = "KhachHang"): KhachHang pk trùng vs tên bảng trong database
public class KhachHang {

    @Id
    @Column(name = "Id")
    @GeneratedValue(strategy = GenerationType.AUTO)
//    @Column(name = "id"): id pk trùng vs cột trong database
//    @GeneratedValue(strategy = GenerationType.AUTO) : nếu id tự tăng
    private UUID id;
    @Column(name = "Ma")
    private String ma;
    @Column(name = "Ten")
